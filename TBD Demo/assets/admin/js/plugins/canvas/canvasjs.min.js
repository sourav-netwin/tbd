/*
 CanvasJS HTML5 & JavaScript Charts - v1.9.6 Beta-1 - http://canvasjs.com/ 
...
*/
(function(){function V(a,d){a.prototype=Qa(d.prototype);a.prototype.constructor=a;a.base=d.prototype}function Qa(a){function d(){}d.prototype=a;return new d}function Ha(a,d,b){"millisecond"===b?a.setMilliseconds(a.getMilliseconds()+1*d):"second"===b?a.setSeconds(a.getSeconds()+1*d):"minute"===b?a.setMinutes(a.getMinutes()+1*d):"hour"===b?a.setHours(a.getHours()+1*d):"day"===b?a.setDate(a.getDate()+1*d):"week"===b?a.setDate(a.getDate()+7*d):"month"===b?a.setMonth(a.getMonth()+1*d):"year"===b&&a.setFullYear(a.getFullYear()+
...
16|a[1]<<8|a[2]:0}function L(a,d,b){return a in d?d[a]:b[a]}function sa(a,d,b){if(v&&Ma){var c=a.getContext("2d");ta=c.webkitBackingStorePixelRatio||c.mozBackingStorePixelRatio||c.msBackingStorePixelRatio||c.oBackingStorePixelRatio||c.backingStorePixelRatio||1;Q=Aa/ta;a.width=d*Q;a.height=b*Q;Aa!==ta&&(a.style.width=d+"px",a.style.height=b+"px",c.scale(Q,Q))}else a.width=d,a.height=b}function Ta(a){if(!Na){var d=!1,b=!1;"undefined"===typeof da.Chart.creditHref?(a.creditHref="http://canvasjs.com/",
...
b&&(d.setAttribute("state",b),d.setAttribute("type","button"),d.style.position="relative",d.style.margin="0px 0px 0px 0px",d.style.padding="3px 4px 0px 4px",d.style.cssFloat="left",d.setAttribute("title",a._cultureInfo[b+"Text"]),d.innerHTML="<img style='height:16px;' src='"+Ua[b].image+"' alt='"+a._cultureInfo[b+"Text"]+"' />")}function ua(){for(var a=null,d=0;d<arguments.length;d++)a=arguments[d],a.style&&(a.style.display="inline")}function $(){for(var a=null,d=0;d<arguments.length;d++)(a=arguments[d])&&
...
Math.max(this.endValue-this.startValue),this._thicknessType="value")}function T(a,d){T.base.constructor.call(this,"ToolTip",d,a.theme,a);this.chart=a;this.canvas=a.canvas;this.ctx=this.chart.ctx;this.currentDataPointIndex=this.currentSeriesIndex=-1;this._timerId=0;this._prevY=this._prevX=NaN;this.optionsName="toolTip";this._initialize()}function ma(a){this.chart=a;this.lastObjectId=0;this.objectMap=[];this.rectangularRegionEventSubscriptions=[];this.previousDataPointEventObject=null;this.ghostCanvas=
ha(this.chart.width,this.chart.height);this.ghostCtx=this.ghostCanvas.getContext("2d");this.mouseoveredObjectMaps=[]}function pa(a){var d;a&&qa[a]&&(d=qa[a]);pa.base.constructor.call(this,"CultureInfo",d)}function Da(a){this.chart=a;this.ctx=this.chart.plotArea.ctx;this.animations=[];this.animationRequestId=null}var J={},v=!!document.createElement("canvas").getContext,da={Chart:{width:500,height:400,zoomEnabled:!1,zoomType:"x",backgroundColor:"white",theme:"theme1",animationEnabled:!1,animationDuration:1200,
dataPointWidth:null,dataPointMinWidth:null,dataPointMaxWidth:null,colorSet:"colorSet1",culture:"en",creditHref:"",creditText:"CanvasJS",interactivityEnabled:!0,exportEnabled:!1,exportFileName:"Chart",rangeChanging:null,colorSet:null,publicProperties:{title:"readWrite",subtitles:"readWrite",toolTip:"readWrite",legend:"readWrite",axisX:"readWrite",axisY:"readWrite",data:"readWrite",options:"readWrite",bounds:"readOnly",container:"readOnly"}},Title:{padding:0,text:null,verticalAlign:"top",horizontalAlign:"center",
...
menuText:"More Options",saveJPGText:"Save as JPEG",savePNGText:"Save as PNG",printText:"Print",days:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),shortDays:"Sun Mon Tue Wed Thu Fri Sat".split(" "),months:"January February March April May June July August September October November December".split(" "),shortMonths:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" ")}},qa={en:{}},ia={colorSet1:"#369EAD #C24642 #7F6084 #86B402 #A2D1CF #C8B631 #6DBCEB #52514E #4F81BC #A064A1 #F79647".split(" "),
colorSet2:"#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #33558B".split(" "),colorSet3:"#8CA1BC #36845C #017E82 #8CB9D0 #708C98 #94838D #F08891 #0366A7 #008276 #EE7757 #E5BA3A #F2990B #03557B #782970".split(" ")},ja={theme1:{Chart:{colorSet:"colorSet1"},Title:{fontFamily:v?"Calibri, Optima, Candara, Verdana, Geneva, sans-serif":"calibri",fontSize:33,fontColor:"#3A3A3A",fontWeight:"bold",verticalAlign:"top",margin:5},Subtitle:{fontFamily:v?"Calibri, Optima, Candara, Verdana, Geneva, sans-serif":
...
DataSeries:{bevelEnabled:!0,indexLabelFontColor:"grey",indexLabelFontFamily:v?"Candara, Optima, Calibri, Verdana, Geneva, sans-serif":"calibri",indexLabelFontSize:18,indexLabelLineColor:"lightgrey",indexLabelLineThickness:2}}},C={numberDuration:1,yearDuration:314496E5,monthDuration:2592E6,weekDuration:6048E5,dayDuration:864E5,hourDuration:36E5,minuteDuration:6E4,secondDuration:1E3,millisecondDuration:1,dayOfWeekFromInt:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")},Ka={},ca=
null,Ea=function(){var a=/D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g,d="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),b="Sun Mon Tue Wed Thu Fri Sat".split(" "),c="January February March April May June July August September October November December".split(" "),f="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),g=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,
h=/[^-+\dA-Z]/g;return function(l,k,n){var m=n?n.days:d,p=n?n.months:c,e=n?n.shortDays:b,r=n?n.shortMonths:f;n="";var q=!1;l=l&&l.getTime?l:l?new Date(l):new Date;if(isNaN(l))throw SyntaxError("invalid date");"UTC:"===k.slice(0,4)&&(k=k.slice(4),q=!0);n=q?"getUTC":"get";var s=l[n+"Date"](),u=l[n+"Day"](),w=l[n+"Month"](),y=l[n+"FullYear"](),t=l[n+"Hours"](),v=l[n+"Minutes"](),aa=l[n+"Seconds"](),Y=l[n+"Milliseconds"](),x=q?0:l.getTimezoneOffset();return n=k.replace(a,function(a){switch(a){case "D":return s;
case "DD":return P(s,2);case "DDD":return e[u];case "DDDD":return m[u];case "M":return w+1;case "MM":return P(w+1,2);case "MMM":return r[w];case "MMMM":return p[w];case "Y":return parseInt(String(y).slice(-2));case "YY":return P(String(y).slice(-2),2);case "YYY":return P(String(y).slice(-3),3);case "YYYY":return P(y,4);case "h":return t%12||12;case "hh":return P(t%12||12,2);case "H":return t;case "HH":return P(t,2);case "m":return v;case "mm":return P(v,2);case "s":return aa;case "ss":return P(aa,
2);case "f":return String(Y).slice(0,1);case "ff":return P(String(Y).slice(0,2),2);case "fff":return P(String(Y).slice(0,3),3);case "t":return 12>t?"a":"p";case "tt":return 12>t?"am":"pm";case "T":return 12>t?"A":"P";case "TT":return 12>t?"AM":"PM";case "K":return q?"UTC":(String(l).match(g)||[""]).pop().replace(h,"");case "z":return(0<x?"-":"+")+Math.floor(Math.abs(x)/60);case "zz":return(0<x?"-":"+")+P(Math.floor(Math.abs(x)/60),2);case "zzz":return(0<x?"-":"+")+P(Math.floor(Math.abs(x)/60),2)+
P(Math.abs(x)%60,2);default:return a.slice(1,a.length-1)}})}}(),ea=function(a,d,b){if(null===a)return"";a=Number(a);var c=0>a?!0:!1;c&&(a*=-1);var f=b?b.decimalSeparator:".",g=b?b.digitGroupSeparator:",",h="";d=String(d);var h=1,l=b="",k=-1,n=[],m=[],p=0,e=0,r=0,q=!1,s=0,l=d.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);d=null;for(var u=0;l&&u<l.length;u++)if(d=l[u],"."===d&&0>k)k=u;else{if("%"===d)h*=100;else if("\u2030"===d){h*=1E3;continue}else if(","===d[0]&&"."===d[d.length-1]){h/=
...
ia[this.colorSet]:ia.colorSet1);this.updateOption("backgroundColor");this.backgroundColor||(this.backgroundColor="rgba(0,0,0,0)");this.updateOption("culture");this._cultureInfo=new pa(this.options.culture);this.updateOption("animationEnabled");this.animationEnabled=this.animationEnabled&&v;this.updateOption("animationDuration");this.updateOption("rangeChanging");this.updateOption("rangeChanged");this.updateOption("exportEnabled");this.updateOption("exportFileName");this.updateOption("zoomType");this.options.zoomEnabled?
(this._zoomButton||($(this._zoomButton=document.createElement("button")),U(this,this._zoomButton,"pan"),this._toolBar.appendChild(this._zoomButton),K(this._zoomButton,"click",function(){a.zoomEnabled?(a.zoomEnabled=!1,a.panEnabled=!0,U(a,a._zoomButton,"zoom")):(a.zoomEnabled=!0,a.panEnabled=!1,U(a,a._zoomButton,"pan"));a.render()})),this._resetButton||($(this._resetButton=document.createElement("button")),U(this,this._resetButton,"reset"),this._toolBar.appendChild(this._resetButton),K(this._resetButton,
"click",function(){a.toolTip.hide();a.zoomEnabled||a.panEnabled?(a.zoomEnabled=!0,a.panEnabled=!1,U(a,a._zoomButton,"pan"),a._defaultCursor="default",a.overlaidCanvas.style.cursor=a._defaultCursor):(a.zoomEnabled=!1,a.panEnabled=!1);if(a.sessionVariables.axisX)for(var b=0;b<a.sessionVariables.axisX.length;b++)a.sessionVariables.axisX[b].newViewportMinimum=null,a.sessionVariables.axisX[b].newViewportMaximum=null;if(a.sessionVariables.axisX2)for(b=0;b<a.sessionVariables.axisX2.length;b++)a.sessionVariables.axisX2[b].newViewportMinimum=
...
"reset");a.render();a._dispatchRangeEvent("rangeChanged","reset")}),this.overlaidCanvas.style.cursor=a._defaultCursor),this.zoomEnabled||this.panEnabled||(this._zoomButton?(a._zoomButton.getAttribute("state")===a._cultureInfo.zoomText?(this.panEnabled=!0,this.zoomEnabled=!1):(this.zoomEnabled=!0,this.panEnabled=!1),ua(a._zoomButton,a._resetButton)):(this.zoomEnabled=!0,this.panEnabled=!1))):this.panEnabled=this.zoomEnabled=!1;this._menuButton?this.exportEnabled?ua(this._menuButton):$(this._menuButton):
this.exportEnabled&&v&&(this._menuButton=document.createElement("button"),U(this,this._menuButton,"menu"),this._toolBar.appendChild(this._menuButton),K(this._menuButton,"click",function(){"none"!==a._dropdownMenu.style.display||a._dropDownCloseTime&&500>=(new Date).getTime()-a._dropDownCloseTime.getTime()||(a._dropdownMenu.style.display="block",a._menuButton.blur(),a._dropdownMenu.focus())},!0));if(!this._dropdownMenu&&this.exportEnabled&&v){this._dropdownMenu=document.createElement("div");this._dropdownMenu.setAttribute("tabindex",
...
"blur",function(){$(a._dropdownMenu);a._dropDownCloseTime=new Date},!0);var d=document.createElement("div");d.style.cssText="padding: 2px 15px 2px 10px";d.innerHTML=this._cultureInfo.printText;this._dropdownMenu.appendChild(d);K(d,"mouseover",function(){this.style.backgroundColor="#EEEEEE"},!0);K(d,"mouseout",function(){this.style.backgroundColor="transparent"},!0);K(d,"click",function(){a.print();$(a._dropdownMenu)},!0);d=document.createElement("div");d.style.cssText="padding: 2px 15px 2px 10px";
d.innerHTML=this._cultureInfo.saveJPGText;this._dropdownMenu.appendChild(d);K(d,"mouseover",function(){this.style.backgroundColor="#EEEEEE"},!0);K(d,"mouseout",function(){this.style.backgroundColor="transparent"},!0);K(d,"click",function(){Ba(a.canvas,"jpeg",a.exportFileName);$(a._dropdownMenu)},!0);d=document.createElement("div");d.style.cssText="padding: 2px 15px 2px 10px";d.innerHTML=this._cultureInfo.savePNGText;this._dropdownMenu.appendChild(d);K(d,"mouseover",function(){this.style.backgroundColor=
"#EEEEEE"},!0);K(d,"mouseout",function(){this.style.backgroundColor="transparent"},!0);K(d,"click",function(){Ba(a.canvas,"png",a.exportFileName);$(a._dropdownMenu)},!0)}"none"!==this._toolBar.style.display&&this._zoomButton&&(this.panEnabled?U(a,a._zoomButton,"zoom"):U(a,a._zoomButton,"pan"),a._resetButton.getAttribute("state")!==a._cultureInfo.resetText&&U(a,a._resetButton,"reset"));this.options.toolTip&&this.toolTip.options!==this.options.toolTip&&(this.toolTip.options=this.options.toolTip);for(var b in this.toolTip.options)this.toolTip.options.hasOwnProperty(b)&&
this.toolTip.updateOption(b)};z.prototype._updateSize=function(){var a=0,d=0;this.options.width?a=this.width:this.width=a=0<this.container.clientWidth?this.container.clientWidth:this.width;this.options.height?d=this.height:this.height=d=0<this.container.clientHeight?this.container.clientHeight:this.height;return this.canvas.width!==a*Q||this.canvas.height!==d*Q?(sa(this.canvas,a,d),sa(this.overlaidCanvas,a,d),sa(this._eventManager.ghostCanvas,a,d),!0):!1};z.prototype._initialize=function(){this._animator?
...
[];this._events=[];this._eventManager&&this._eventManager.reset();this.plotInfo={axisPlacement:null,axisXValueType:null,plotTypes:[]};this.layoutManager=new ka(0,0,this.width,this.height,2);this.plotArea.layoutManager&&this.plotArea.layoutManager.reset();this.data=[];var a=0;if(this.options.data)for(var d=0;d<this.options.data.length;d++)if(a++,!this.options.data[d].type||0<=z._supportedChartTypes.indexOf(this.options.data[d].type)){var b=new ba(this,this.options.data[d],a-1,++this._eventManager.lastObjectId);
...
"xySwapped"):"none"==c&&("normal"===this.plotInfo.axisPlacement?f='You cannot combine "'+b.type+'" with line, area, column or bar chart':"xySwapped"===this.plotInfo.axisPlacement?f='You cannot combine "'+b.type+'" with bar chart':null===this.plotInfo.axisPlacement&&(this.plotInfo.axisPlacement="none"));if(f&&window.console){window.console.log(f);return}}J.fAWm&&J.fAWm(this);Ta(this);this._objectsInitialized=!0};z._supportedChartTypes=ra("line stepLine spline column area stepArea splineArea bar bubble scatter stackedColumn stackedColumn100 stackedBar stackedBar100 stackedArea stackedArea100 candlestick ohlc rangeColumn rangeBar rangeArea rangeSplineArea pie doughnut funnel".split(" "));
...
this.axisX2[0].gridThickness&&"undefined"===typeof this.axisX[0].options.gridThickness&&(this.axisX[0].gridThickness=0));b=!1;if(0<this._axes.length&&(this.zoomEnabled||this.panEnabled))for(a=0;a<this._axes.length;a++)if(null!==this._axes[a].viewportMinimum||null!==this._axes[a].viewportMaximum){b=!0;break}b?ua(this._zoomButton,this._resetButton):($(this._zoomButton,this._resetButton),this.options.zoomEnabled&&(this.zoomEnabled=!0,this.panEnabled=!1));this._processData();this.options.title&&(this.title=
...
n.dataPoint.indexLabelFormatter(y):n.dataPoint.indexLabel?this.replaceKeywordsWithValue(n.dataPoint.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):n.dataSeries.indexLabelFormatter?n.dataSeries.indexLabelFormatter(y):n.dataSeries.indexLabel?this.replaceKeywordsWithValue(n.dataSeries.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):null;if(null!==t&&""!==t){var w=L("indexLabelPlacement",n.dataPoint,n.dataSeries),y=L("indexLabelOrientation",n.dataPoint,n.dataSeries),v=n.direction,aa=
n.dataSeries.axisX,Y=n.dataSeries.axisY,z=!1,r=new X(d,{x:0,y:0,maxWidth:f?f:0.5*this.width,maxHeight:g?5*k:1.5*k,angle:"horizontal"===y?0:-90,text:t,padding:0,backgroundColor:r,horizontalAlign:"left",fontSize:k,fontFamily:p,fontWeight:h,fontColor:l,fontStyle:e,textBaseline:"top"});r.measureText();n.dataSeries.indexLabelMaxWidth=r.maxWidth;if(0<=m.indexOf("line")||0<=m.indexOf("area")||0<=m.indexOf("bubble")||0<=m.indexOf("scatter")){if(n.dataPoint.x<aa.viewportMinimum||n.dataPoint.x>aa.viewportMaximum||
n.dataPoint.y<Y.viewportMinimum||n.dataPoint.y>Y.viewportMaximum)continue}else if(0<=m.indexOf("column")){if(n.dataPoint.x<aa.viewportMinimum||n.dataPoint.x>aa.viewportMaximum||n.bounds.y1>b.y2||n.bounds.y2<b.y1)continue}else if(0<=m.indexOf("bar")){if(n.dataPoint.x<aa.viewportMinimum||n.dataPoint.x>aa.viewportMaximum||n.bounds.x1>b.x2||n.bounds.x2<b.x1)continue}else if(n.dataPoint.x<aa.viewportMinimum||n.dataPoint.x>aa.viewportMaximum)continue;f=h=2;"horizontal"===y?(l=r.width,k=r.height):(k=r.width,
l=r.height);if("normal"===this.plotInfo.axisPlacement){if(0<=m.indexOf("line")||0<=m.indexOf("area"))w="auto",h=4;else if(0<=m.indexOf("stacked"))"auto"===w&&(w="inside");else if("bubble"===m||"scatter"===m)w="inside";p=n.point.x-l/2;"inside"!==w?(f=b.y1,g=b.y2,0<v?(e=n.point.y-k-h-c,e<f&&(e="auto"===w?Math.max(n.point.y,f)+h+c:f+h+c,z=e+k>n.point.y)):(e=n.point.y+h+c,e>g-k-h-c&&(e="auto"===w?Math.min(n.point.y,g)-k-h-c:g-k-h-c,z=e<n.point.y))):(f=Math.max(n.bounds.y1,b.y1),g=Math.min(n.bounds.y2,
b.y2),c=0<=m.indexOf("range")?0<v?Math.max(n.bounds.y1,b.y1)+k/2+h:Math.min(n.bounds.y2,b.y2)-k/2-h:(Math.max(n.bounds.y1,b.y1)+Math.min(n.bounds.y2,b.y2))/2,0<v?(e=Math.max(n.point.y,c)-k/2,e<f&&("bubble"===m||"scatter"===m)&&(e=Math.max(n.point.y-k-h,b.y1+h))):(e=Math.min(n.point.y,c)-k/2,e>g-k-h&&("bubble"===m||"scatter"===m)&&(e=Math.min(n.point.y+h,b.y2-k-h))),e=Math.min(e,g-k))}else 0<=m.indexOf("line")||0<=m.indexOf("area")||0<=m.indexOf("scatter")?(w="auto",f=4):0<=m.indexOf("stacked")?"auto"===
w&&(w="inside"):"bubble"===m&&(w="inside"),e=n.point.y-k/2,"inside"!==w?(h=b.x1,g=b.x2,0>v?(p=n.point.x-l-f-c,p<h&&(p="auto"===w?Math.max(n.point.x,h)+f+c:h+f+c,z=p+l>n.point.x)):(p=n.point.x+f+c,p>g-l-f-c&&(p="auto"===w?Math.min(n.point.x,g)-l-f-c:g-l-f-c,z=p<n.point.x))):(h=Math.max(n.bounds.x1,b.x1),Math.min(n.bounds.x2,b.x2),c=0<=m.indexOf("range")?0>v?Math.max(n.bounds.x1,b.x1)+l/2+f:Math.min(n.bounds.x2,b.x2)-l/2-f:(Math.max(n.bounds.x1,b.x1)+Math.min(n.bounds.x2,b.x2))/2,p=0>v?Math.max(n.point.x,
...
(n=k[s].lineDashType,d.setLineDash(F(n,l.lineThickness))):(n=l.lineDashType,d.setLineDash(p))));if(0<k[s].markerSize||0<l.markerSize)t=l.getMarkerProperties(s,u,w,d),f=t.color,c.push(t),G=D(G),v&&c.push({x:u,y:w,ctx:b,type:t.type,size:t.size,color:G,borderColor:G,borderThickness:t.borderThickness});(k[s].indexLabel||l.indexLabel||k[s].indexLabelFormatter||l.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:k[s],dataSeries:l,point:{x:u,y:w},direction:0>k[s].y===a.axisY.reversed?
...
q,b.setLineDash&&(n[s].lineDashType?(m=n[s].lineDashType,y[y.length-1].newLineDashArray=F(m,k.lineThickness)):(m=k.lineDashType,y[y.length-1].newLineDashArray=e)));if(0<n[s].markerSize||0<k.markerSize){var G=k.getMarkerProperties(s,u,w,b),g=G.color;f.push(G);t=D(t);v&&f.push({x:u,y:w,ctx:c,type:G.type,size:G.size,color:t,borderColor:t,borderThickness:G.borderThickness})}(n[s].indexLabel||k.indexLabel||n[s].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:n[s],
...
c.rect(k.x1,k.y1,k.width,k.height),c.clip());for(k=0;k<a.dataSeriesIndexes.length;k++){var n=a.dataSeriesIndexes[k],m=this.data[n],p=m.dataPoints,h=m.id;this._eventManager.objectMap[h]={objectType:"dataSeries",dataSeriesIndex:n};h=D(h);c.fillStyle=h;var h=[],e=!0,r=0,q,s,u,w=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),y,t=null;if(0<p.length){var G=m._colorSet[r%m._colorSet.length],x=m.lineColor=m.options.lineColor||G,Y=x;b.fillStyle=G;b.strokeStyle=x;b.lineWidth=m.lineThickness;
var z="solid";if(b.setLineDash){var A=F(m.nullDataLineDashType,m.lineThickness),z=m.lineDashType,R=F(z,m.lineThickness);b.setLineDash(R)}for(var I=!0;r<p.length;r++)if(u=p[r].x.getTime?p[r].x.getTime():p[r].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!I)))if("number"!==typeof p[r].y)m.connectNullData||(I||e)||d(),I=!0;else{q=a.axisX.convertValueToPixel(u);s=a.axisY.convertValueToPixel(p[r].y);e||I?(!e&&m.connectNullData?(b.setLineDash&&(m.options.nullDataLineDashType||
z===m.lineDashType&&m.lineDashType!==m.nullDataLineDashType)&&(b.stroke(),z=m.nullDataLineDashType,b.setLineDash(A)),b.lineTo(q,s),v&&c.lineTo(q,s)):(b.beginPath(),b.moveTo(q,s),v&&(c.beginPath(),c.moveTo(q,s)),t={x:q,y:s}),I=e=!1):(b.lineTo(q,s),v&&c.lineTo(q,s),0==r%250&&d());r<p.length-1&&(Y!==(p[r].lineColor||x)||z!==(p[r].lineDashType||m.lineDashType))&&(d(),Y=p[r].lineColor||x,b.strokeStyle=Y,b.setLineDash&&(p[r].lineDashType?(z=p[r].lineDashType,b.setLineDash(F(z,m.lineThickness))):(z=m.lineDashType,
b.setLineDash(R))));var H=m.dataPointIds[r];this._eventManager.objectMap[H]={id:H,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:r,x1:q,y1:s};0!==p[r].markerSize&&(0<p[r].markerSize||0<m.markerSize)&&(u=m.getMarkerProperties(r,q,s,b),l=u.color,h.push(u),H=D(H),v&&h.push({x:q,y:s,ctx:c,type:u.type,size:u.size,color:H,borderColor:H,borderThickness:u.borderThickness}));(p[r].indexLabel||m.indexLabel||p[r].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",
dataPoint:p[r],dataSeries:m,point:{x:q,y:s},direction:0>p[r].y===a.axisY.reversed?1:-1,color:G})}d();O.drawMarkers(h);m.markerColor=l}}b.restore();v&&this._eventManager.ghostCtx.restore();return{source:b,dest:this.plotArea.ctx,animationCallback:E.xClipAnimation,easingFunction:E.easing.linear,animationBase:0}}};z.prototype.renderSplineArea=function(a){function d(){var d=va(y,2);if(0<d.length){if(0<m.lineThickness){b.beginPath();b.moveTo(d[0].x,d[0].y);d[0].newStrokeStyle&&(b.strokeStyle=d[0].newStrokeStyle);
...
h=m.id;this._eventManager.objectMap[h]={objectType:"dataSeries",dataSeriesIndex:n};h=D(h);c.fillStyle=h;var h=[],e=0,r,q,s=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),u,w=null,y=[];if(0<p.length){var t=m._colorSet[e%m._colorSet.length],G=m.lineColor=m.options.lineColor||t,x=G;b.fillStyle=t;b.strokeStyle=G;b.lineWidth=m.lineThickness;var z="solid";if(b.setLineDash){var A=F(m.nullDataLineDashType,m.lineThickness),z=m.lineDashType,S=F(z,m.lineThickness);b.setLineDash(S)}for(q=
!1;e<p.length;e++)if(r=p[e].x.getTime?p[e].x.getTime():p[e].x,!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!q)))if("number"!==typeof p[e].y)0<e&&!q&&(m.connectNullData?b.setLineDash&&(0<y.length&&(m.options.nullDataLineDashType||!p[e-1].lineDashType))&&(y[y.length-1].newLineDashArray=A,z=m.nullDataLineDashType):(d(),y=[])),q=!0;else{r=a.axisX.convertValueToPixel(r);q=a.axisY.convertValueToPixel(p[e].y);var R=m.dataPointIds[e];this._eventManager.objectMap[R]=
{id:R,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:e,x1:r,y1:q};y[y.length]={x:r,y:q};e<p.length-1&&(x!==(p[e].lineColor||G)||z!==(p[e].lineDashType||m.lineDashType))&&(x=p[e].lineColor||G,y[y.length-1].newStrokeStyle=x,b.setLineDash&&(p[e].lineDashType?(z=p[e].lineDashType,y[y.length-1].newLineDashArray=F(z,m.lineThickness)):(z=m.lineDashType,y[y.length-1].newLineDashArray=S)));if(0!==p[e].markerSize&&(0<p[e].markerSize||0<m.markerSize)){var I=m.getMarkerProperties(e,r,q,b),l=I.color;
h.push(I);R=D(R);v&&h.push({x:r,y:q,ctx:c,type:I.type,size:I.size,color:R,borderColor:R,borderThickness:I.borderThickness})}(p[e].indexLabel||m.indexLabel||p[e].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[e],dataSeries:m,point:{x:r,y:q},direction:0>p[e].y===a.axisY.reversed?1:-1,color:t});q=!1}d();O.drawMarkers(h);m.markerColor=l}}b.restore();v&&this._eventManager.ghostCtx.restore();return{source:b,dest:this.plotArea.ctx,animationCallback:E.xClipAnimation,
...
dataSeriesIndex:n};h=D(h);c.fillStyle=h;var h=[],e=!0,r=0,q,s,u,w=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),y,t=null,G=!1;if(0<p.length){var x=m._colorSet[r%m._colorSet.length],z=m.lineColor=m.options.lineColor||x,A=z;b.fillStyle=x;b.strokeStyle=z;b.lineWidth=m.lineThickness;var S="solid";if(b.setLineDash){var R=F(m.nullDataLineDashType,m.lineThickness),S=m.lineDashType,I=F(S,m.lineThickness);b.setLineDash(I)}for(;r<p.length;r++)if(u=p[r].x.getTime?p[r].x.getTime():
p[r].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!G))){var H=s;"number"!==typeof p[r].y?(m.connectNullData||(G||e)||d(),G=!0):(q=a.axisX.convertValueToPixel(u),s=a.axisY.convertValueToPixel(p[r].y),e||G?(!e&&m.connectNullData?(b.setLineDash&&(m.options.nullDataLineDashType||S===m.lineDashType&&m.lineDashType!==m.nullDataLineDashType)&&(b.stroke(),S=m.nullDataLineDashType,b.setLineDash(R)),b.lineTo(q,H),b.lineTo(q,s),v&&(c.lineTo(q,H),c.lineTo(q,s))):(b.beginPath(),
b.moveTo(q,s),v&&(c.beginPath(),c.moveTo(q,s)),t={x:q,y:s}),G=e=!1):(b.lineTo(q,H),v&&c.lineTo(q,H),b.lineTo(q,s),v&&c.lineTo(q,s),0==r%250&&d()),r<p.length-1&&(A!==(p[r].lineColor||z)||S!==(p[r].lineDashType||m.lineDashType))&&(d(),A=p[r].lineColor||z,b.strokeStyle=A,b.setLineDash&&(p[r].lineDashType?(S=p[r].lineDashType,b.setLineDash(F(S,m.lineThickness))):(S=m.lineDashType,b.setLineDash(I)))),H=m.dataPointIds[r],this._eventManager.objectMap[H]={id:H,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:r,
x1:q,y1:s},0!==p[r].markerSize&&(0<p[r].markerSize||0<m.markerSize)&&(u=m.getMarkerProperties(r,q,s,b),l=u.color,h.push(u),H=D(H),v&&h.push({x:q,y:s,ctx:c,type:u.type,size:u.size,color:H,borderColor:H,borderThickness:u.borderThickness})),(p[r].indexLabel||m.indexLabel||p[r].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:p[r],dataSeries:m,point:{x:q,y:s},direction:0>p[r].y===a.axisY.reversed?1:-1,color:x}))}d();O.drawMarkers(h);m.markerColor=l}}b.restore();
...
if(!(0>=a.dataSeriesIndexes.length)){var c=null,f=[],g=null,h=this.plotArea,l=[],k=[],n=[],m=[],p=0,e,r,q,s=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),u=this._eventManager.ghostCtx;v&&u.beginPath();b.save();v&&u.save();b.beginPath();b.rect(h.x1,h.y1,h.width,h.height);b.clip();v&&(u.beginPath(),u.rect(h.x1,h.y1,h.width,h.height),u.clip());for(var w=[],h=0;h<a.dataSeriesIndexes.length;h++){var y=a.dataSeriesIndexes[h],t=this.data[y],x=t.dataPoints;t.dataPointIndexes=
[];for(p=0;p<x.length;p++)y=x[p].x.getTime?x[p].x.getTime():x[p].x,t.dataPointIndexes[y]=p,w[y]||(n.push(y),w[y]=!0);n.sort(za)}for(h=0;h<a.dataSeriesIndexes.length;h++){y=a.dataSeriesIndexes[h];t=this.data[y];x=t.dataPoints;w=!0;k=[];p=t.id;this._eventManager.objectMap[p]={objectType:"dataSeries",dataSeriesIndex:y};p=D(p);u.fillStyle=p;if(0<n.length){var c=t._colorSet[0],z=t.lineColor=t.options.lineColor||c,Y=z;b.fillStyle=c;b.strokeStyle=z;b.lineWidth=t.lineThickness;var A="solid";if(b.setLineDash){var S=
F(t.nullDataLineDashType,t.lineThickness),A=t.lineDashType,R=F(A,t.lineThickness);b.setLineDash(R)}for(var I=!0,p=0;p<n.length;p++){q=n[p];var H=null,H=0<=t.dataPointIndexes[q]?x[t.dataPointIndexes[q]]:{x:q,y:null};if(!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!t.connectNullData||!I)))if("number"!==typeof H.y)t.connectNullData||(I||w)||d(),I=!0;else{e=a.axisX.convertValueToPixel(q);var fa=l[q]?l[q]:0;if(a.axisY.logarithmic){m[q]=H.y+(m[q]?m[q]:0);if(0>=m[q])continue;r=a.axisY.convertValueToPixel(m[q])}else r=
a.axisY.convertValueToPixel(H.y),r-=fa;k.push({x:e,y:s-fa});l[q]=s-r;w||I?(!w&&t.connectNullData?(b.setLineDash&&(t.options.nullDataLineDashType||A===t.lineDashType&&t.lineDashType!==t.nullDataLineDashType)&&(b.stroke(),A=t.nullDataLineDashType,b.setLineDash(S)),b.lineTo(e,r),v&&u.lineTo(e,r)):(b.beginPath(),b.moveTo(e,r),v&&(u.beginPath(),u.moveTo(e,r))),I=w=!1):(b.lineTo(e,r),v&&u.lineTo(e,r),0==p%250&&(d(),b.moveTo(e,r),v&&u.moveTo(e,r),k.push({x:e,y:s-fa})));p<x.length-1&&(Y!==(x[p].lineColor||
z)||A!==(x[p].lineDashType||t.lineDashType))&&(d(),b.beginPath(),b.moveTo(e,r),k.push({x:e,y:s-fa}),Y=x[p].lineColor||z,b.strokeStyle=Y,b.setLineDash&&(x[p].lineDashType?(A=x[p].lineDashType,b.setLineDash(F(A,t.lineThickness))):(A=t.lineDashType,b.setLineDash(R))));if(0<=t.dataPointIndexes[q]){var ga=t.dataPointIds[t.dataPointIndexes[q]];this._eventManager.objectMap[ga]={id:ga,objectType:"dataPoint",dataSeriesIndex:y,dataPointIndex:t.dataPointIndexes[q],x1:e,y1:r}}0<=t.dataPointIndexes[q]&&0!==H.markerSize&&
(0<H.markerSize||0<t.markerSize)&&(q=t.getMarkerProperties(p,e,r,b),g=q.color,f.push(q),markerColor=D(ga),v&&f.push({x:e,y:r,ctx:u,type:q.type,size:q.size,color:markerColor,borderColor:markerColor,borderThickness:q.borderThickness}));(H.indexLabel||t.indexLabel||H.indexLabelFormatter||t.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:H,dataSeries:t,point:{x:e,y:r},direction:0>x[p].y===a.axisY.reversed?1:-1,color:c})}}d();b.moveTo(e,r);v&&u.moveTo(e,r)}delete t.dataPointIndexes;
...
x[p].x.getTime?x[p].x.getTime():x[p].x,t.dataPointIndexes[y]=p,w[y]||(n.push(y),w[y]=!0);n.sort(za)}for(f=0;f<a.dataSeriesIndexes.length;f++){y=a.dataSeriesIndexes[f];t=this.data[y];x=t.dataPoints;w=!0;c=t.id;this._eventManager.objectMap[c]={objectType:"dataSeries",dataSeriesIndex:y};c=D(c);u.fillStyle=c;k=[];if(0<n.length){var c=t._colorSet[p%t._colorSet.length],z=t.lineColor=t.options.lineColor||c,Y=z;b.fillStyle=c;b.strokeStyle=z;b.lineWidth=t.lineThickness;var A="solid";if(b.setLineDash){var S=
F(t.nullDataLineDashType,t.lineThickness),A=t.lineDashType,R=F(A,t.lineThickness);b.setLineDash(R)}for(var I=!0,p=0;p<n.length;p++){q=n[p];var H=null,H=0<=t.dataPointIndexes[q]?x[t.dataPointIndexes[q]]:{x:q,y:null};if(!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!t.connectNullData||!I)))if("number"!==typeof H.y)t.connectNullData||(I||w)||d(),I=!0;else{var fa;fa=0!==a.dataPointYSums[q]?100*(H.y/a.dataPointYSums[q]):0;e=a.axisX.convertValueToPixel(q);var ga=l[q]?l[q]:0;if(a.axisY.logarithmic){m[q]=
fa+(m[q]?m[q]:0);if(0>=m[q])continue;r=a.axisY.convertValueToPixel(m[q])}else r=a.axisY.convertValueToPixel(fa),r-=ga;k.push({x:e,y:s-ga});l[q]=s-r;w||I?(!w&&t.connectNullData?(b.setLineDash&&(t.options.nullDataLineDashType||A===t.lineDashType&&t.lineDashType!==t.nullDataLineDashType)&&(b.stroke(),A=t.nullDataLineDashType,b.setLineDash(S)),b.lineTo(e,r),v&&u.lineTo(e,r)):(b.beginPath(),b.moveTo(e,r),v&&(u.beginPath(),u.moveTo(e,r))),I=w=!1):(b.lineTo(e,r),v&&u.lineTo(e,r),0==p%250&&(d(),b.moveTo(e,
r),v&&u.moveTo(e,r),k.push({x:e,y:s-ga})));p<x.length-1&&(Y!==(x[p].lineColor||z)||A!==(x[p].lineDashType||t.lineDashType))&&(d(),b.beginPath(),b.moveTo(e,r),k.push({x:e,y:s-ga}),Y=x[p].lineColor||z,b.strokeStyle=Y,b.setLineDash&&(x[p].lineDashType?(A=x[p].lineDashType,b.setLineDash(F(A,t.lineThickness))):(A=t.lineDashType,b.setLineDash(R))));if(0<=t.dataPointIndexes[q]){var Fa=t.dataPointIds[t.dataPointIndexes[q]];this._eventManager.objectMap[Fa]={id:Fa,objectType:"dataPoint",dataSeriesIndex:y,dataPointIndex:t.dataPointIndexes[q],
x1:e,y1:r}}0<=t.dataPointIndexes[q]&&0!==H.markerSize&&(0<H.markerSize||0<t.markerSize)&&(q=t.getMarkerProperties(p,e,r,b),h=q.color,g.push(q),markerColor=D(Fa),v&&g.push({x:e,y:r,ctx:u,type:q.type,size:q.size,color:markerColor,borderColor:markerColor,borderThickness:q.borderThickness}));(H.indexLabel||t.indexLabel||H.indexLabelFormatter||t.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:H,dataSeries:t,point:{x:e,y:r},direction:0>x[p].y===a.axisY.reversed?1:-1,color:c})}}d();
...
z=n.lineDashType,C=F(z,n.lineThickness);b.setLineDash(C)}for(var S=!0;e<m.length;e++)if(u=m[e].x.getTime?m[e].x.getTime():m[e].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!S)))if(null!==m[e].y&&m[e].y.length&&"number"===typeof m[e].y[0]&&"number"===typeof m[e].y[1]){r=a.axisX.convertValueToPixel(u);q=a.axisY.convertValueToPixel(m[e].y[0]);s=a.axisY.convertValueToPixel(m[e].y[1]);p||S?(n.connectNullData&&!p?(b.setLineDash&&(n.options.nullDataLineDashType||
z===n.lineDashType&&n.lineDashType!==n.nullDataLineDashType)&&(l[l.length-1].newLineDashArray=C,z=n.nullDataLineDashType,b.setLineDash(A)),b.lineTo(r,q),v&&c.lineTo(r,q),l.push({x:r,y:s})):(b.beginPath(),b.moveTo(r,q),w={x:r,y:q},l=[],l.push({x:r,y:s}),v&&(c.beginPath(),c.moveTo(r,q))),S=p=!1):(b.lineTo(r,q),l.push({x:r,y:s}),v&&c.lineTo(r,q),0==e%250&&d());u=n.dataPointIds[e];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:e,x1:r,y1:q,y2:s};e<m.length-
1&&(x!==(m[e].lineColor||t)||z!==(m[e].lineDashType||n.lineDashType))&&(d(),x=m[e].lineColor||t,l[l.length-1].newStrokeStyle=x,b.strokeStyle=x,b.setLineDash&&(m[e].lineDashType?(z=m[e].lineDashType,l[l.length-1].newLineDashArray=F(z,n.lineThickness),b.setLineDash(l[l.length-1].newLineDashArray)):(z=n.lineDashType,l[l.length-1].newLineDashArray=C,b.setLineDash(C))));if(0!==m[e].markerSize&&(0<m[e].markerSize||0<n.markerSize)){var R=n.getMarkerProperties(e,r,s,b);f.push(R);var I=D(u);v&&f.push({x:r,
y:s,ctx:c,type:R.type,size:R.size,color:I,borderColor:I,borderThickness:R.borderThickness});R=n.getMarkerProperties(e,r,q,b);g=R.color;f.push(R);I=D(u);v&&f.push({x:r,y:q,ctx:c,type:R.type,size:R.size,color:I,borderColor:I,borderThickness:R.borderThickness})}if(m[e].indexLabel||n.indexLabel||m[e].indexLabelFormatter||n.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:m[e],dataSeries:n,indexKeyword:0,point:{x:r,y:q},direction:m[e].y[0]>m[e].y[1]===a.axisY.reversed?-1:1,color:y}),
this._indexLabels.push({chartType:"rangeArea",dataPoint:m[e],dataSeries:n,indexKeyword:1,point:{x:r,y:s},direction:m[e].y[0]>m[e].y[1]===a.axisY.reversed?1:-1,color:y})}else S||p||d(),S=!0;d();O.drawMarkers(f);n.markerColor=g}}b.restore();v&&this._eventManager.ghostCtx.restore();return{source:b,dest:this.plotArea.ctx,animationCallback:E.xClipAnimation,easingFunction:E.easing.linear,animationBase:0}}};z.prototype.renderRangeSplineArea=function(a){function d(a,d){var e=va(q,2);if(0<e.length){if(0<k.lineThickness){b.strokeStyle=
...
x)));if(0!==n[m].markerSize&&(0<n[m].markerSize||0<k.markerSize)){var C=k.getMarkerProperties(m,p,e,b),g=C.color;f.push(C);var S=D(A);v&&f.push({x:p,y:e,ctx:c,type:C.type,size:C.size,color:S,borderColor:S,borderThickness:C.borderThickness});C=k.getMarkerProperties(m,p,r,b);f.push(C);S=D(A);v&&f.push({x:p,y:r,ctx:c,type:C.type,size:C.size,color:S,borderColor:S,borderThickness:C.borderThickness})}if(n[m].indexLabel||k.indexLabel||n[m].indexLabelFormatter||k.indexLabelFormatter)this._indexLabels.push({chartType:"splineArea",
...
a?0.75*Math.min(e.width,e.height)/2:0.92*Math.min(e.width,e.height)/2;n.radius&&(A=Oa(n.radius,A));var C="undefined"!==typeof n.innerRadius&&null!==n.innerRadius?Oa(n.innerRadius,A):0.7*A;n.radius=A;"doughnut"===n.type&&(n.innerRadius=C);var E=Math.min(C/A,(A-1)/A);this.pieDoughnutClickHandler=function(a){k.isAnimating||!x(a.dataSeries.explodeOnClick)&&!a.dataSeries.explodeOnClick||(a=a.dataPoint,a.exploded=a.exploded?!1:!0,1<this.dataPoints.length&&k._animator.animate(0,500,function(a){b(a);l()}))};
d();h();h();h();h();this.disableToolTip=!0;this._animator.animate(0,this.animatedRender?this.animationDuration:0,function(a){var b=k.plotArea.ctx;b.clearRect(e.x1,e.y1,e.width,e.height);b.fillStyle=k.backgroundColor;b.fillRect(e.x1,e.y1,e.width,e.height);a=r[0].startAngle+2*Math.PI*a;for(b=0;b<m.length;b++){var c=0===b?r[b].startAngle:d,d=c+(r[b].endAngle-r[b].startAngle),f=!1;d>a&&(d=a,f=!0);var g=m[b].color?m[b].color:n._colorSet[b%n._colorSet.length];d>c&&Ga(k.plotArea.ctx,r[b].center,r[b].radius,
...
d);Ba(this.canvas,d,b)};z.prototype.print=function(){var a=this.exportChart({toDataURL:!0}),d=document.createElement("iframe");d.setAttribute("class","canvasjs-chart-print-frame");d.setAttribute("style","position:absolute; width:100%; border: 0px; margin: 0px 0px 0px 0px; padding 0px 0px 0px 0px;");d.style.height=this.height+"px";this._canvasJSContainer.appendChild(d);var b=this,c=d.contentWindow||d.contentDocument.document||d.contentDocument;c.document.open();c.document.write('<!DOCTYPE HTML>\n<html><body style="margin: 0px 0px 0px 0px; padding: 0px 0px 0px 0px;"><img src="'+
...
2;e.x2=this.chart._eventManager.objectMap[e.id].x2=e.textBlock.x+e.textBlock.width;e.y2=this.chart._eventManager.objectMap[e.id].y2=e.textBlock.y+e.textBlock.height-this.lineHeight/2}d+=v}0<k.length&&a.layoutManager.registerSpace(b,{width:this.width+2+2,height:this.height+5+5});this.bounds={x1:f,y1:c,x2:f+this.width,y2:c+this.height}};V(Ca,M);Ca.prototype.render=function(){var a=this.chart.layoutManager.getFreeSpace();this.ctx.fillStyle="red";this.ctx.fillRect(a.x1,a.y1,a.x2,a.y2)};V(ba,M);ba.prototype.getDefaultAxisPlacement=
...
this._labels[0].position))/Math.log(this.range):this.lineCoordinates.width/(this.logarithmic&&this.equidistantInterval?Math.log(this.range)/Math.log(this.logarithmBase):Math.abs(this.range))*C[this.intervalType+"Duration"]*this.interval,g="undefined"===typeof this.options.labelMaxWidth?0.5*this.chart.width>>0:this.options.labelMaxWidth,this.chart.panEnabled||(h="undefined"===typeof this.options.labelWrap||this.labelWrap?0.8*this.chart.height>>0:1.5*this.labelFontSize);else if("left"===this._position||
"right"===this._position)k=this.logarithmic&&!this.equidistantInterval&&2<=this._labels.length?this.lineCoordinates.height*Math.log(Math.min(this._labels[this._labels.length-1].position/this._labels[this._labels.length-2].position,this._labels[1].position/this._labels[0].position))/Math.log(this.range):this.lineCoordinates.height/(this.logarithmic&&this.equidistantInterval?Math.log(this.range)/Math.log(this.logarithmBase):Math.abs(this.range))*C[this.intervalType+"Duration"]*this.interval,this.chart.panEnabled||
...
new X(c[e].ctx,{text:c[e].title,horizontalAlign:"center",fontSize:c[e].titleFontSize,fontFamily:c[e].titleFontFamily,fontWeight:c[e].titleFontWeight,fontColor:c[e].titleFontColor,fontStyle:c[e].titleFontStyle,textBaseline:"top"}));if("normal"===f){var u=[],w=[],v=[],t=[],H=[],J=[],M=[],K=[];if(a&&0<a.length)for(e=0;e<a.length;e++)a[e]&&a[e].title&&(a[e]._titleTextBlock.maxWidth=a[e].titleMaxWidth||g.width,a[e]._titleTextBlock.maxHeight=a[e].titleWrap?0.8*g.height:1.5*a[e].titleFontSize,a[e]._titleTextBlock.angle=
...
c[e].title&&(c[e]._titleTextBlock.maxWidth=c[e].titleMaxWidth||g.height,c[e]._titleTextBlock.maxHeight=c[e].titleWrap?0.8*g.width:1.5*c[e].titleFontSize,c[e]._titleTextBlock.angle=90);for(;4>r;){var N=0,Q=0,O=0,P=0,L=f=0,B=0,T=0,Z=0,W=0,V=0,U=0;if(b&&0<b.length)for(v=[],e=V=0;e<b.length;e++)v.push(Math.ceil(b[e]?b[e].createLabelsAndCalculateWidth():0)),V+=v[e],B+=b[e]?b[e].margin:0;else v.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateWidth():0));M.push(v);if(c&&0<c.length)for(t=[],e=U=0;e<c.length;e++)t.push(Math.ceil(c[e]?
c[e].createLabelsAndCalculateWidth():0)),U+=t[e],T+=c[e]?c[e].margin:0;else t.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateWidth():0));K.push(t);h=Math.round(g.x1+V+B);k=Math.round(g.x2-U-T>m.width-10?m.width-10:g.x2-U-T);if(a&&0<a.length)for(u=[],e=Z=0;e<a.length;e++)a[e]&&(a[e].lineCoordinates={}),a[e].lineCoordinates.width=Math.abs(k-h),a[e].title&&(a[e]._titleTextBlock.maxWidth=0<a[e].titleMaxWidth&&a[e].titleMaxWidth<a[e].lineCoordinates.width?a[e].titleMaxWidth:a[e].lineCoordinates.width),
u.push(Math.ceil(a[e]?a[e].createLabelsAndCalculateHeight():0)),Z+=u[e],f+=a[e]?a[e].margin:0;else u.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateHeight():0));H.push(u);if(d&&0<d.length)for(w=[],e=W=0;e<d.length;e++)d[e]&&(d[e].lineCoordinates={}),d[e].lineCoordinates.width=Math.abs(k-h),d[e].title&&(d[e]._titleTextBlock.maxWidth=0<d[e].titleMaxWidth&&d[e].titleMaxWidth<d[e].lineCoordinates.width?d[e].titleMaxWidth:d[e].lineCoordinates.width),w.push(Math.ceil(d[e]?d[e].createLabelsAndCalculateHeight():
0)),W+=w[e],L+=d[e]?d[e].margin:0;else w.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateHeight():0));J.push(w);if(a&&0<a.length)for(e=0;e<a.length;e++)a[e]&&(a[e].lineCoordinates.x1=h,a[e].lineCoordinates.x2=Math.round(g.x2-U-T>m.width-10?m.width-10:g.x2-U-T),a[e]._labels&&1<a[e]._labels.length&&(l=n=0,n=a[e]._labels[1],l="dateTime"===a[e].chart.plotInfo.axisXValueType?a[e]._labels[a[e]._labels.length-2]:a[e]._labels[a[e]._labels.length-1],q=n.textBlock.width*Math.cos(Math.PI/180*Math.abs(n.textBlock.angle))+
(n.textBlock.height-l.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(n.textBlock.angle)),s=l.textBlock.width*Math.cos(Math.PI/180*Math.abs(l.textBlock.angle))+(l.textBlock.height-l.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(l.textBlock.angle))),a[e]&&(a[e].labelAutoFit&&!x(z)&&!x(A))&&(l=0,0<a[e].labelAngle?A+s>k&&(l+=0<a[e].labelAngle?A+s-k-U:0):0>a[e].labelAngle?z-q<h&&z-q<a[e].viewportMinimum&&(C=h-(B+a[e].tickLength+v+z-q+a[e].labelFontSize/2)):0===a[e].labelAngle&&(A+s>k&&(l=A+
s/2-k-U),z-q<h&&z-q<a[e].viewportMinimum&&(C=h-B-a[e].tickLength-v-z+q/2)),a[e].viewportMaximum===a[e].maximum&&a[e].viewportMinimum===a[e].minimum&&0<a[e].labelAngle&&0<l?k-=l:a[e].viewportMaximum===a[e].maximum&&a[e].viewportMinimum===a[e].minimum&&0>a[e].labelAngle&&0<C?h+=C:a[e].viewportMaximum===a[e].maximum&&a[e].viewportMinimum===a[e].minimum&&0===a[e].labelAngle&&(0<C&&(h+=C),0<l&&(k-=l))),m.panEnabled?Z=m.sessionVariables.axisX.height:m.sessionVariables.axisX.height=Z,l=Math.round(g.y2-Z-
f+N),n=Math.round(g.y2),a[e].lineCoordinates.x2=k,a[e].lineCoordinates.width=k-h,a[e].lineCoordinates.y1=l,a[e].lineCoordinates.y2=l,a[e].bounds={x1:h,y1:l,x2:k,y2:n-(Z+f-u[e]-N),width:k-h,height:n-l}),N+=u[e]+a[e].margin;if(d&&0<d.length)for(e=0;e<d.length;e++)d[e].lineCoordinates.x1=Math.round(g.x1+V+B),d[e].lineCoordinates.x2=Math.round(g.x2-U-T>m.width-10?m.width-10:g.x2-U-T),d[e].lineCoordinates.width=Math.abs(k-h),d[e]._labels&&1<d[e]._labels.length&&(n=d[e]._labels[1],l="dateTime"===d[e].chart.plotInfo.axisXValueType?
...
if(c&&0<c.length)for(e=0;e<c.length;e++)c[e].calculateValueToPixelConversionParameters();if(0<r){if(a&&0<a.length)for(e=0;e<a.length;e++)D=H[r-1][e]===H[r][e]?!0:!1;else D=!0;if(d&&0<d.length)for(e=0;e<d.length;e++)E=J[r-1][e]===J[r][e]?!0:!1;else E=!0;if(b&&0<b.length)for(e=0;e<b.length;e++)F=M[r-1][e]===M[r][e]?!0:!1;else F=!0;if(c&&0<c.length)for(e=0;e<c.length;e++)I=K[r-1][e]===K[r][e]?!0:!1;else I=!0}if(D&&E&&F&&I)break;r++}p.save();p.beginPath();a[0]&&p.rect(5,a[0].bounds.y1,a[0].chart.width-
10,a[0].bounds.height);d[0]&&p.rect(5,d[d.length-1].bounds.y1,d[0].chart.width-10,d[0].bounds.height);p.clip();if(a&&0<a.length)for(e=0;e<a.length;e++)a[e].renderLabelsTicksAndTitle();if(d&&0<d.length)for(e=0;e<d.length;e++)d[e].renderLabelsTicksAndTitle();p.restore();if(b&&0<b.length)for(e=0;e<b.length;e++)b[e].renderLabelsTicksAndTitle();if(c&&0<c.length)for(e=0;e<c.length;e++)c[e].renderLabelsTicksAndTitle()}else{z=[];A=[];C=[];q=[];s=[];H=[];J=[];M=[];if(a&&0<a.length)for(e=0;e<a.length;e++)a[e]&&
...
b[e].createLabelsAndCalculateHeight():0)),P+=z[e]+b[e].margin,B+=b[e].margin;else z.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateHeight():0));s.push(z);if(c&&0<c.length)for(A=[],e=V=0;e<c.length;e++)A.push(Math.ceil(c[e]?c[e].createLabelsAndCalculateHeight():0)),V+=A[e],T+=c[e].margin;else A.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateHeight():0));H.push(A);if(b&&0<b.length)for(e=0;e<b.length;e++)0<b[e]._labels.length&&(n=b[e]._labels[0],l=b[e]._labels[b[e]._labels.length-1],u=n.textBlock.width*
...
10)?Math.max(B,10):g.y1):g.y1<Math.max(B,10)?Math.max(B,10):g.y1;k=Math.round(g.x1+Z+f);n=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y1:g.y2-P>m.height-Math.max(B,10)?m.height-Math.max(B,10):g.y2-P):g.y2>m.height-Math.max(B,10)?m.height-Math.max(B,10):g.y2;if(b&&0<b.length)for(B=0;B<b.length;B++)b[B]&&b[B].labelAutoFit&&(k=0>b[B].labelAngle?Math.max(k,u):0===b[B].labelAngle?Math.max(k,u/2):k,h=0>b[B].labelAngle||0===b[B].labelAngle?k-Z:h);if(c&&0<c.length)for(B=0;B<c.length;B++)c[B]&&c[B].labelAutoFit&&
(k=c[B].lineCoordinates.x1,h=k-Z);a[e].lineCoordinates={x1:k-K,y1:l,x2:k-K,y2:n,height:Math.abs(n-l)};a[e].bounds={x1:k-(C[e]+K),y1:l,x2:k,y2:n,width:k-h,height:n-l};a[e].title&&(a[e]._titleTextBlock.maxWidth=0<a[e].titleMaxWidth&&a[e].titleMaxWidth<a[e].lineCoordinates.height?a[e].titleMaxWidth:a[e].lineCoordinates.height);a[e].calculateValueToPixelConversionParameters();K+=C[e]+a[e].margin}if(d&&0<d.length)for(e=0;e<d.length;e++){B=d[e]._labels&&0<d[e]._labels.length?d[e]._labels[0].textBlock.fontSize/
...
"millisecond"):c/(1*C.secondDuration)<=a?(this.interval=1,this.intervalType="second"):c/(2*C.secondDuration)<=a?(this.interval=2,this.intervalType="second"):c/(5*C.secondDuration)<=a?(this.interval=5,this.intervalType="second"):c/(10*C.secondDuration)<=a?(this.interval=10,this.intervalType="second"):c/(15*C.secondDuration)<=a?(this.interval=15,this.intervalType="second"):c/(20*C.secondDuration)<=a?(this.interval=20,this.intervalType="second"):c/(30*C.secondDuration)<=a?(this.interval=30,this.intervalType=
"second"):c/(1*C.minuteDuration)<=a?(this.interval=1,this.intervalType="minute"):c/(2*C.minuteDuration)<=a?(this.interval=2,this.intervalType="minute"):c/(5*C.minuteDuration)<=a?(this.interval=5,this.intervalType="minute"):c/(10*C.minuteDuration)<=a?(this.interval=10,this.intervalType="minute"):c/(15*C.minuteDuration)<=a?(this.interval=15,this.intervalType="minute"):c/(20*C.minuteDuration)<=a?(this.interval=20,this.intervalType="minute"):c/(30*C.minuteDuration)<=a?(this.interval=30,this.intervalType=
"minute"):c/(1*C.hourDuration)<=a?(this.interval=1,this.intervalType="hour"):c/(2*C.hourDuration)<=a?(this.interval=2,this.intervalType="hour"):c/(3*C.hourDuration)<=a?(this.interval=3,this.intervalType="hour"):c/(6*C.hourDuration)<=a?(this.interval=6,this.intervalType="hour"):c/(1*C.dayDuration)<=a?(this.interval=1,this.intervalType="day"):c/(2*C.dayDuration)<=a?(this.interval=2,this.intervalType="day"):c/(4*C.dayDuration)<=a?(this.interval=4,this.intervalType="day"):c/(1*C.weekDuration)<=a?(this.interval=
1,this.intervalType="week"):c/(2*C.weekDuration)<=a?(this.interval=2,this.intervalType="week"):c/(3*C.weekDuration)<=a?(this.interval=3,this.intervalType="week"):c/(1*C.monthDuration)<=a?(this.interval=1,this.intervalType="month"):c/(2*C.monthDuration)<=a?(this.interval=2,this.intervalType="month"):c/(3*C.monthDuration)<=a?(this.interval=3,this.intervalType="month"):c/(6*C.monthDuration)<=a?(this.interval=6,this.intervalType="month"):(this.interval=c/(1*C.yearDuration)<=a?1:c/(2*C.yearDuration)<=
a?2:c/(4*C.yearDuration)<=a?4:Math.floor(A.getNiceNumber(c/(a-1),!0)/C.yearDuration),this.intervalType="year"));if(null===this.viewportMinimum||isNaN(this.viewportMinimum))this.viewportMinimum=f-h/2;if(null===this.viewportMaximum||isNaN(this.viewportMaximum))this.viewportMaximum=g+h/2;d?this.autoValueFormatString="MMM DD YYYY HH:mm":"year"===this.intervalType?this.autoValueFormatString="YYYY":"month"===this.intervalType?this.autoValueFormatString="MMM YYYY":"week"===this.intervalType?this.autoValueFormatString=
...
d){var b=Math.floor(Math.log(a)/Math.LN10),c=a/Math.pow(10,b);return Number(((d?1.5>c?1:3>c?2:7>c?5:10:1>=c?1:2>=c?2:5>=c?5:10)*Math.pow(10,b)).toFixed(20))};A.prototype.getLabelStartPoint=function(){var a=C[this.intervalType+"Duration"]*this.interval,a=new Date(Math.floor(this.viewportMinimum/a)*a);if("millisecond"!==this.intervalType)if("second"===this.intervalType)0<a.getMilliseconds()&&(a.setSeconds(a.getSeconds()+1),a.setMilliseconds(0));else if("minute"===this.intervalType){if(0<a.getSeconds()||
...
l);this.ctx.stroke();this.ctx.globalAlpha=c}this.ctx.restore()};V(T,M);T.prototype._initialize=function(){if(this.enabled){this.container=document.createElement("div");this.container.setAttribute("class","canvasjs-chart-tooltip");this.container.style.position="absolute";this.container.style.height="auto";this.container.style.boxShadow="1px 1px 2px 2px rgba(0,0,0,0.1)";this.container.style.zIndex="1000";this.container.style.display="none";var a;a='<div style=" width: auto;height: auto;min-width: 50px;';
...
function(a,d){this._lastUpdated&&40>(new Date).getTime()-this._lastUpdated||(this._lastUpdated=(new Date).getTime(),this._updateToolTip(a,d))};T.prototype._updateToolTip=function(a,d,b){b="undefined"===typeof b?!0:b;this.container||this._initialize();this.enabled||this.hide();if(!this.chart.disableToolTip){if("undefined"===typeof a||"undefined"===typeof d){if(isNaN(this._prevX)||isNaN(this._prevY))return;a=this._prevX;d=this._prevY}else this._prevX=a,this._prevY=d;var c=null,f=null,g=[],h=0;if(this.shared&&
...
"rangeColumn"===c.type?N(d,f.x1,f.y1,f.x2,f.y2,"white",0,null,!1,!1,!1,!1,0.3):"pie"===c.type||"doughnut"===c.type?Ga(d,f.center,f.radius,"white",c.type,f.startAngle,f.endAngle,0.3,f.percentInnerRadius):"candlestick"===c.type?(d.globalAlpha=1,d.strokeStyle=f.color,d.lineWidth=2*f.borderThickness,c=0===d.lineWidth%2?0:0.5,d.beginPath(),d.moveTo(f.x3-c,Math.min(f.y2,f.y3)),d.lineTo(f.x3-c,Math.min(f.y1,f.y4)),d.stroke(),d.beginPath(),d.moveTo(f.x3-c,Math.max(f.y1,f.y4)),d.lineTo(f.x3-c,Math.max(f.y2,
...
b;else return"";h=h[a];null!==e&&(h=h[e]);if("x"===a)if("dateTime"===g.plotInfo.axisXValueType||"dateTime"===b.xValueType||d.x&&d.x.getTime){if(g.plotInfo.plotTypes[0].plotUnits[0].axisX&&!g.plotInfo.plotTypes[0].plotUnits[0].axisX.logarithmic)return Ea(h,d.xValueFormatString?d.xValueFormatString:b.xValueFormatString?b.xValueFormatString:b.xValueFormatString=g.axisX&&g.axisX.autoValueFormatString?g.axisX.autoValueFormatString:"DD MMM YY",g._cultureInfo)}else return ea(h,d.xValueFormatString?d.xValueFormatString:
b.xValueFormatString?b.xValueFormatString:b.xValueFormatString="#,##0.########",g._cultureInfo);else return"y"===a?ea(h,d.yValueFormatString?d.yValueFormatString:b.yValueFormatString?b.yValueFormatString:b.yValueFormatString="#,##0.########",g._cultureInfo):"z"===a?ea(h,d.zValueFormatString?d.zValueFormatString:b.zValueFormatString?b.zValueFormatString:b.zValueFormatString="#,##0.########",g._cultureInfo):h})};ma.prototype.reset=function(){this.lastObjectId=0;this.objectMap=[];this.rectangularRegionEventSubscriptions=
[];this.previousDataPointEventObject=null;this.eventObjects=[];v&&(this.ghostCtx.clearRect(0,0,this.chart.width,this.chart.height),this.ghostCtx.beginPath())};ma.prototype.getNewObjectTrackingId=function(){return++this.lastObjectId};ma.prototype.mouseEventHandler=function(a){if("mousemove"===a.type||"click"===a.type){var d=[],b=ya(a),c=null;if((c=this.chart.getObjectAtXY(b.x,b.y,!1))&&"undefined"!==typeof this.objectMap[c])if(c=this.objectMap[c],"dataPoint"===c.objectType){var f=this.chart.data[c.dataSeriesIndex],
...
d){qa[a]=d},formatNumber:function(a,d,b){b=b||"en";if(qa[b])return ea(a,d||"#,##0.##",new pa(b));throw"Unknown Culture Name";},formatDate:function(a,d,b){b=b||"en";if(qa[b])return Ea(a,d||"DD MMM YYYY",new pa(b));throw"Unknown Culture Name";}};Pa.Chart.version="v1.9.6 Beta-1";window.CanvasJS=Pa})();
/*
