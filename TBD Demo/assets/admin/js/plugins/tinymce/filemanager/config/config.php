...
$upload_dir = '/assets/images/content_upload/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../../images/content_upload/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../../../images/content_thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
...
$icon_theme 		= "ico_dark"; //ico or ico_dark you can cusatomize just putting a folder inside filemanager/img
