...
$(function(){
	...
	*/
	...
	if($('#categories_count').length > 0){
        ...
        if($('#goal-completion-view').length > 0){
            $.ajax({
                    url: base_url+'admin/insights/get_goal_completion_view',
                    type: 'POST',
                    dataType: 'json',
                    data:{},
                    success: function(data){
                            ...
                            if(data.result == 1){
                                    ...
                                    $('#goal-completion-view').html(showHtml);
                            }
                    }
            });
	}
                    ...
                    success: function(data){
                       if(data.result == 1){
                          ...
                          // Show Yearly data in graph 
                            ...
                            // This will get the first returned node in the jQuery collection.
                            var salesChart = new Chart(salesChartCanvas);
                            //var monthData = [28, 48, 40, 19, 86, 27, 90,19, 86, 27, 90,80];    
                            var salesChartData = {
