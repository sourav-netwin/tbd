...
<div class="row wid-row margin-top-10" id="home_main_details">
...
<div class="row">
    ...
    <div class="col-xs-12" style="width:94.5% !important;margin-left:29px;">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Year-to-Date Report</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    <div class="col-md-8">
...
<div class="row wid-row margin-top-10" id="all-category-view" style="display:none">
    <div class="col-xs-12">
    <input type="button" id="back_btn_dash" class="btn btn-default btn-xs pull-right" style="margin-right: 20px" value="<< Back" />
    <div class="col-sm-12" id="dash_bc"><ul><li id="all-category-view-title">Category wise product views</li></ul></div>
    <div class="col-sm-12" id="all-category-view-expansion">
...
<div class="row">
    ...
    <div class="col-md-8" style="width:94.5% !important;margin-left:29px;">
        <!-- MAP & BOX PANE -->
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="pad box-pane-right bg-green" style="min-height: 280px">
                            <div class="description-block margin-bottom">
                                <div class="sparkbar pad" data-color="#fff" id="visitString">90,70,90,70,75,80,70</div>
                                <h5 class="description-header" id="totalUsers">8390</h5>
