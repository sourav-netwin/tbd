    ...
    <div class="col-lg-12">
        <div class="col-xs-12 col-md-12 col-sm-12">            
            <?php if( !empty($main_categories) ) { ?>
                <select class="form-control select-filter search_product_select" id="product_main_category" name="product_main_category">
            ...
            <div class="form-group pull-right">
                <a class="btn btn-primary btn-xs" href="houseproduct/add"> Add Product</a>
            </div>
        </div>
