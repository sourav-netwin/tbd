<?php echo form_open_multipart('houseproduct/edit_post/' . $Id, array('id' => 'products_form', 'class' => 'form-horizontal','autocomplete'=>'off')); ?>
<div class="row">
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-xs-6">
                    ...
                    <input type="text" class="form-control" name="brand" placeholder="Brand" readonly="" value="<?php echo $Brand ?>">
                    <div class="error">
