...
<div class="row">
    <?php echo form_open_multipart('products/add', array('id' => 'products_form', 'class' => 'form-horizontal products_add_form', 'autocomplete' => 'off','autocomplete'=>'off')); ?>
