    ...
    <script type="text/javascript">
        function init_tinymce(){
            ...
            tinymce.init({
                ...
                font_formats: 'Andale Mono=andale mono,times;'+ 'Arial=arial,helvetica,sans-serif;'+ 'Arial Black=arial black,avant garde;'+ 'Book Antiqua=book antiqua,palatino;'+ 'Comic Sans MS=comic sans ms,sans-serif;'+ 'Courier New=courier new,courier;'+ 'Georgia=georgia,palatino;'+ 'Helvetica=helvetica;'+ 'Impact=impact,chicago;'+ 'Questrial=Questrial-Regular;'+ 'Raleway=raleway,zapf dingbats;'+ 'Symbol=symbol;'+ 'Tahoma=tahoma,arial,helvetica,sans-serif;'+ 'Terminal=terminal,monaco;'+ 'Times New Roman=times new roman,times;'+ 'Trebuchet MS=trebuchet ms,geneva;'+ 'Verdana=verdana,geneva;'+ 'Webdings=webdings;'+ 'Wingdings=wingdings,zapf dingbats',
...
<?php } ?>
<script src="<?php echo $this -> config -> item('admin_assets'); ?>js/pages/percircle.js"></script>
<script src="<?php echo $this -> config -> item('admin_assets'); ?>js/pages/raphael-min.js"></script>
<script src="<?php echo $this -> config -> item('admin_assets'); ?>js/pages/morris-0.5.0.min.js"></script>
